...
<div class="menu-intro">
    <h1>Welcome to Briscola Restaurant</h1>
    <p>Discover our authentic Italian cuisine and chef specials.</p>
</div>
...
<div class="chef-section">
    ...
    <div class="chefs">
        <div class="chef">
            <img src="images/chef1.jpg" alt="Marco Rossi">
            <h3>Marco Rossi</h3>
            <p>Head Chef – Expert in Italian pasta and seafood dishes.</p>
        </div>
        <div class="chef">
            <img src="images/manager.jpg" alt="Lisa Chen">
            <h3>Lisa Chen</h3>
            <p>Pastry Chef – Creator of our signature desserts and gelato.</p>
        </div>
    </div>
</div>
